...
import { BsFillSunFill, BsMoonStarsFill, BsGear } from "react-icons/bs"; // Tambahkan ikon pengaturan
...
export default function Navbar({ isOpen, setIsOpen }: NavbarProps) {
  ...
  const [showIcons, setShowIcons] = useState<boolean>(false); // State untuk menampilkan ikon
