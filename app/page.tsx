        ...
        <motion.div
          ...
          <div className='flex flex-col items-center text-center'>
            ...
            <p className='text-neutral-500 dark:text-neutral-300 text-base'>
              I am a <b>Fullstack Developer</b> from Indonesia with a fairly
              strong understanding of programming languages ​​and experience in
              several <b>Web Development</b> projects.
            </p>
          </div>
        </motion.div>
        <motion.div
          className='flex flex-col md:flex-row space-y-4 md:space-y-0 space-x-0 md:space-x-4 mt-10 items-center'
          initial='hidden'
          whileInView='visible'
          viewport={{ once: true }}
